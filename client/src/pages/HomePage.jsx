...
export function HomePage({ onOpenAuth, onNavigateDashboard }) {
  ...
  useEffect(() => {
    ...
    api.getAdminOverview().then(data => {
      if (data?.budget) {
        setGrantStats({
          totalPool: data.budget.totalGrantPool,
          remaining: data.budget.remainingPool,
          activeCount: data.budget.activeSubsidiesCount
        });
      }
    }).catch(() => {
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-xs text-slate-400 max-w-lg mx-auto mt-1">
              We never display ads, sell user data, or inject parking links. Every ₹0 domain is funded directly from our community grant fund.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-4xl mx-auto">
            <div className="p-6 rounded-2xl bg-slate-900/80 border border-slate-800 text-center">
              ...
              <div className="text-3xl font-black text-white mt-1">₹{grantStats.totalPool.toLocaleString()}</div>
            ...
            <div className="p-6 rounded-2xl bg-slate-900/80 border border-emerald-500/30 text-center shadow-lg shadow-emerald-950/20">
              ...
              <div className="text-3xl font-black text-emerald-400 mt-1">₹{grantStats.remaining.toLocaleString()}</div>
      ...
      <section id="how-it-works" className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-black text-white mt-1">How Does the ₹0 Subsidy Work?</h2>
            <p className="text-xs text-slate-400 max-w-lg mx-auto mt-1">
      ...
      <section id="eligibility" className="py-16 px-4 sm:px-6 lg:px-8 bg-slate-900/40 border-t border-slate-800">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-black text-white mt-1">Who Can Receive a ₹0 Subsidy?</h2>
            <p className="text-xs text-slate-400 max-w-lg mx-auto mt-1">
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          ...
          <div className="space-y-4 text-xs">
            ...
            <div className="p-5 rounded-xl bg-slate-900/60 border border-slate-800 space-y-2">
              ...
              <p className="text-slate-400 leading-relaxed">
                Your domain is registered with a legitimate registrar. At the end of the 1st subsidized year, you can renew it at the registrar’s wholesale cost without markup, or transfer it out freely to any registrar of your choice using your EPP authorization code.
              </p>
            </div>
